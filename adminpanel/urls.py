...
urlpatterns = [
    ...
    path('setting/user-admin/role', views.setting_role, name='setting_role'),
    ...
    path('invoice/ajax/select_counter_id', views.select_counter_id_inv, name='select_counter_id_inv'),
...
path('invoice/template/delete=<int:id>', views.invoice_template_delete, name='invoice_template_delete'),
    ...
    path('message/create/ajax/select_flat_section', views.select_flat_message_section, name='select_flat_message_section'),
    path('message/create/ajax/select_flat_floor', views.select_flat_message_floor, name='select_flat_message_floor'),
